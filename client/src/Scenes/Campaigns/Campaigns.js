...
import { Row, Col, Typography, Button, Modal, Input, Table, Carousel } from 'antd'
          ...
          <Row>
            <Col flex="auto">
              <Input
                ...
                onChange={search}
              />
              <Table scroll={{ x: 1500 }} columns={columns} dataSource={filterTable == null ? campaigns : filterTable} size="small" />
            </Col>
          </Row>
        </Col>
      </Row>
